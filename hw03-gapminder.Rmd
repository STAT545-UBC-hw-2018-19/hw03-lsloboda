...
2. Select the year, continent, population and life expectancy
3. Evaluate the traditional mean, weighted mean by population and trimmed mean (trimming 5 values on either end of the data)
4. Present the data in a table
5. Visualize the data in a graph
6. Interpret the data
*Reflections:*
*there's way too much data to view it for all years in table format; graph format is better for this*
*table format shows the exact values, which is a nice benefit*
...
#Let's take one subset of the data
...
6. Interpret the data
*Reflections:*
*Lots of trials and error to realize that you can group after the mutate command; initially I was thinking that you could only group at the beginning*
